...
## Enable FTM (FTMx_MODE)
<p> To enable FTM, FTMx_MODE bit 0 needs to be set. <br>
FTMx_MODE has a write protection flag in Bit 2 <br>
(default is 1: write protection disabled) </p>
